export default function Footer() {
  return (
    <footer className="bg-rajputi-green text-rajputi-ivory mt-10">
            ...
            <div className="mt-4 flex space-x-6">
              ...
              <a href="#" className="hover:text-rajputi-pink" aria-label="Facebook">
                <svg className="h-6 w-6 fill-current" viewBox="0 0 24 24">
                  ...
                  1.49-3.89 3.77-3.89 1.09 0 2.23.2 2.23.2v2.46h-1.26c-1.24 
                  0-1.63.77-1.63 1.56V12h2.78l-.44 2.89h-2.34v6.99C18.34 
                  21.13 22 17 22 12z"/>
                </svg>
              </a>
              ...
              <a href="#" className="hover:text-rajputi-pink" aria-label="Instagram">
                <svg className="h-6 w-6 fill-current" viewBox="0 0 24 24">
                  ...
                  1 7.5 2zm0 2A3.5 3.5 0 0 0 4 7.5v9A3.5 3.5 0 0 0 
                  7.5 20h9a3.5 3.5 0 0 0 3.5-3.5v-9A3.5 3.5 0 0 0 
                  16.5 4h-9zm4.5 3.5a5 5 0 1 1 0 10 5 5 0 0 
                  1 0-10zm0 2a3 3 0 1 0 0 6 3 3 0 0 0 0-6zm5.25-2.75a1.25 
                  1.25 0 1 1-2.5 0 1.25 1.25 0 0 1 2.5 0z"/>
                </svg>
              </a>
              ...
              <a href="#" className="hover:text-rajputi-pink" aria-label="Twitter">
                <svg className="h-6 w-6 fill-current" viewBox="0 0 24 24">
                  ...
                  1.04 4.28 4.28 0 0 0-7.3 3.9A12.14 12.14 
                  0 0 1 3.15 4.6a4.27 4.27 0 0 0 1.32 5.7 
                  4.25 4.25 0 0 1-1.94-.54v.05a4.28 4.28 
                  0 0 0 3.44 4.2 4.28 4.28 0 0 1-1.93.07 
                  4.28 4.28 0 0 0 4 2.97A8.58 8.58 0 0 
                  1 2 19.54a12.1 12.1 0 0 0 6.56 1.92c7.88 
                  0 12.2-6.53 12.2-12.2 0-.19 0-.38-.01-.57A8.7 
                  8.7 0 0 0 22 5.92z"/>
                </svg>
              </a>
            </div>
